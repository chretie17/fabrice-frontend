...
const CourseManagement = ({ selectedBatch, onClose }) => {
  ...
  const fetchCourseData = async () => {
    ...
    setError('');
    try {
      // Get course details with lessons and assignments using batch's course_id
  ...
  const handleGradeSubmission = async () => {
    setLoading(true);
    try {
      // Update submission with grade directly
      ...
      await fetchSubmissions(gradingSubmission.assignment_id);
          ...
          <div className="space-y-4">
            ...
            {submissions.length > 0 && (
              <div className="border-t pt-6 mt-6">
                <h4 className="font-medium mb-4">Assignment Submissions</h4>
                <div className="space-y-3">
                    ...
                    <div key={submission.id} className="border rounded-lg p-4 flex justify-between items-center">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <button
                          ...
                          className="bg-blue-100 text-blue-700 px-3 py-1 rounded-md hover:bg-blue-200 flex items-center space-x-1"
                        >
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl">
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              {gradingSubmission.submission_text && (
                <p className="text-gray-700 mb-2">{gradingSubmission.submission_text}</p>
              )}
              {gradingSubmission.file_path && (
                <p className="text-blue-600">📎 File attached: {gradingSubmission.file_path}</p>
              )}
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Score * (Max: {gradingSubmission.max_points || 100})
                </label>
                <input
                  type="number"
                  ...
                  min="0"
                  max={gradingSubmission.max_points || 100}
                  className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500"
                  required
                />
              </div>
