...
const generatePDF = async (title) => {
  ...
  const addMetadataAfterTable = (startY) => {
    ...
    doc.text(`Generated By: SANGWA FABRICE`, 15, yPosition);
    yPosition += 6;
  ...
  // Table configuration
 // Update the getTableConfig function to fix header formatting:
...
const getTableConfig = (startY) => ({
  ...
  headStyles: {
    ...
    cellPadding: 2, // Add cell padding
    minCellHeight: 10 // Set minimum cell height
  },
  bodyStyles: {
    fontSize: 8,
    cellPadding: 3,
    textColor: [44, 62, 80],
    valign: 'middle' // Add vertical alignment for body
  },
  alternateRowStyles: {
